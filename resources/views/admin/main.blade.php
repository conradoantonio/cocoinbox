...
<head>
    <title>@yield('title', isset($title) ? $title .' | Coco Inbox' : 'Coco Inbox')</title>
    <meta charset="utf-8">
        ...
        <div class="navbar-inner">
            ...
            <div class="header-seperation"> 
                ...
                <a href="{{url('dashboard')}}">
                    <img src="{{ asset('img/logo.png') }}" class="logo" alt="" data-src="{{ asset('img/logo.png') }}" data-src-retina="{{ asset('img/logo.png') }}" width="80" height="28"/>
                </a>
                <!-- END LOGO --> 
    ...
    <div class="page-container row-fluid">
        ...
        <div class="page-sidebar" id="main-menu"> 
            ...
            <ul>    
                ...
                <!-- BEGIN SINGLE LINK -->
                <li class="{{$menu == 'Mis pedidos activos' ? 'active' : ''}}">
                    <a href="{{url('pedidos')}}">
                ...
                <!-- BEGIN SINGLE LINK -->
                <li class="{{$menu == 'Pedidos finalizados' ? 'active' : ''}}">
                    <a href="{{url('pedidos_finalizados')}}">
                        <i class="fa fa-check-square-o" aria-hidden="true"></i>
                        <span class="title">Historial pedidos</span>
                    </a>
                </li>
                <!-- END SINGLE LINK -->
    
                <!-- BEGIN SINGLE LINK -->
                <li class="{{$menu == 'Platillos' ? 'active' : ''}}">
                ...
                <!-- BEGIN SINGLE LINK -->
                <li class="{{$menu == 'Repartidores' ? 'active' : ''}}">
                    <a href="{{url('repartidores')}}">
